...
<div class="container">
			...
			<div class="form-group">
                        <label id="label-text-color" for="email">Email</label>
                        <input type="email" name="email" placeholder="email@email.com" required value="<?php if($error) echo $email; ?>" class="email" />
