...
function register_user($register_data) {
	...
	"Hello " . $register_data['first_name'] . ",\n\nTo activate your BSU PingPong  account, please click the link below:\n\nhttp://www.bsu-pingpong.com/activate.php?email=" .$register_data['email'] . "&email_code=" . $register_data['email_code']."\n\n-bsu-pingpong.com ");
